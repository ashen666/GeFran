...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private CheckBox sw_bool_Manual_Auto;
	private CheckBox sw_bool_Refrigeration;
	private CheckBox sw_bool_Heating;
	private CheckBox sw_bool_Arefaction;
	private CheckBox sw_bool_Humidification;
	private Spinner sp_enum_Manual_Auto_status;
	private Spinner sp_enum_Dehumidification;
	private Spinner sp_enum_AirConditioning;
	private TextView tv_data_Humidity;
	private TextView tv_data_Temperature;
	private TextView te_text;
	private TextView te_text1;
	private TextView te_text2;
	...
	private void initView() {
		...
		sw_bool_Manual_Auto = (CheckBox) findViewById(R.id.sw_bool_Manual_Auto);
		sw_bool_Refrigeration = (CheckBox) findViewById(R.id.sw_bool_Refrigeration);
		sw_bool_Heating = (CheckBox) findViewById(R.id.sw_bool_Heating);
		sw_bool_Arefaction = (CheckBox) findViewById(R.id.sw_bool_Arefaction);
		sw_bool_Humidification = (CheckBox) findViewById(R.id.sw_bool_Humidification);
		sp_enum_Manual_Auto_status = (Spinner) findViewById(R.id.sp_enum_Manual_Auto_status);
		sp_enum_Dehumidification = (Spinner) findViewById(R.id.sp_enum_Dehumidification);
		sp_enum_AirConditioning = (Spinner) findViewById(R.id.sp_enum_AirConditioning);
		...
		te_text = (TextView) findViewById(R.id.te_text);
		te_text1 = (TextView) findViewById(R.id.te_text1);
		te_text2 = (TextView) findViewById(R.id.te_text2);
	}

	private void initEvent() {
		te_text.setOnClickListener(this);
		te_text1.setOnClickListener(this);
		te_text2.setOnClickListener(this);
		sw_bool_Manual_Auto.setOnClickListener(this);
		sw_bool_Refrigeration.setOnClickListener(this);
		sw_bool_Heating.setOnClickListener(this);
		sw_bool_Arefaction.setOnClickListener(this);
		sw_bool_Humidification.setOnClickListener(this);
		sp_enum_Manual_Auto_status.setEnabled(false);
		sp_enum_Dehumidification.setEnabled(false);
		sp_enum_AirConditioning.setEnabled(false);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_Manual_Auto:
			sendCommand(KEY_MANUAL_AUTO, sw_bool_Manual_Auto.isChecked());
			break;
		case R.id.sw_bool_Refrigeration:
			sendCommand(KEY_REFRIGERATION, sw_bool_Refrigeration.isChecked());

			break;
		case R.id.sw_bool_Heating:
			sendCommand(KEY_HEATING, sw_bool_Heating.isChecked());
			break;
		case R.id.sw_bool_Arefaction:
			sendCommand(KEY_AREFACTION, sw_bool_Arefaction.isChecked());
			break;
		case R.id.sw_bool_Humidification:
			sendCommand(KEY_HUMIDIFICATION, sw_bool_Humidification.isChecked());
			break;
	...
	protected void updateUI() {
		...
		sw_bool_Manual_Auto.setChecked(data_Manual_Auto);


		//sw_bool_Manual_Auto.setEnabled(true);//默认设置按钮可点击


		//sw_bool_Manual_Auto.setChecked(data_Refrigeration);
	/*	sw_bool_Manual_Auto.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			@Override
			public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
				...
				if (b) {
					...
					//sw_bool_Refrigeration.setChecked(true);
					sw_bool_Refrigeration.setEnabled(true);
					//sw_bool_Heating.setChecked(true);
					sw_bool_Heating.setEnabled(true);
					//sw_bool_Arefaction.setChecked(true);
					sw_bool_Arefaction.setEnabled(true);
					//sw_bool_Humidification.setChecked(true);
					sw_bool_Humidification.setEnabled(true);


				} else {


					sw_bool_Refrigeration.setChecked(false);
					sw_bool_Refrigeration.setEnabled(false);
					sw_bool_Heating.setChecked(false);
					sw_bool_Heating.setEnabled(false);
					sw_bool_Arefaction.setChecked(false);
					sw_bool_Arefaction.setEnabled(false);
					sw_bool_Humidification.setChecked(false);
					sw_bool_Humidification.setEnabled(false);
			...
			sp_enum_Manual_Auto_status.setSelection(data_Manual_Auto_status, true);
			switch (data_Manual_Auto_status) {
				case 1: //开机校验更新回传
					te_text2.setText("手动");   //接收到下位机信息打印到TEXT
					//sw_bool_Refrigeration.setChecked(true);
					sw_bool_Refrigeration.setEnabled(true);
					//sw_bool_Heating.setChecked(true);
					sw_bool_Heating.setEnabled(true);
					...
					break;
				case 0: //开机校验更新回传
					te_text2.setText("自动");   //接收到下位机信息打印到TEXT
					sw_bool_Refrigeration.setChecked(false);
					sw_bool_Refrigeration.setEnabled(false);
					sw_bool_Heating.setChecked(false);
					sw_bool_Heating.setEnabled(false);
			...
			sp_enum_Dehumidification.setSelection(data_Dehumidification, true);
			switch (data_Dehumidification) {
				case 0: //开机校验更新回传
					te_text1.setText("恒湿");   //接收到下位机信息打印到TEXT
					break;
				case 1: //开机校验更新回传
					te_text1.setText("加湿");   //接收到下位机信息打印到TEXT
					break;
				case 2: //开机校验更新回传
					te_text1.setText("除湿");   //接收到下位机信息打印到TEXT
					break;
				case 3: //开机校验更新回传
					te_text1.setText("停湿");   //接收到下位机信息打印到TEXT
					break;
				default:
					break;
			}
			sp_enum_AirConditioning.setSelection(data_AirConditioning, true);
			switch (data_AirConditioning) {
				case 0: //开机校验更新回传
					te_text.setText("恒温");   //接收到下位机信息打印到TEXT
					break;
				case 1: //开机校验更新回传
					te_text.setText("制热");   //接收到下位机信息打印到TEXT
					break;
				case 2: //开机校验更新回传
					te_text.setText("制冷");   //接收到下位机信息打印到TEXT
					break;
				case 3: //开机校验更新回传
					te_text.setText("停温");   //接收到下位机信息打印到TEXT
					break;
				default:
					break;
			}
